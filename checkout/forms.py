...
def cc_expire_years():
  """Returns a list of tuples to populate a drop-down menu for tweleve years into the future
  """
...
def cc_expire_months():
  """Returns a list of tuples containing months of the year for use in credit card form.
...
class CheckoutForm(forms.ModelForm):
  ...
  class Meta:
    ...
    # Excluding the following from the form
    exclude = (
      'status',
      'ip_address',
      'user',
  ...
  # These form entry types are not part of the model
